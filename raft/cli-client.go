...
func clientSet(shell *Shell, args []string) {
	return shell.c.SendRequest(raft.SET, []byte(args[1]+":"+args[2]))
}

//This function gets something in the map
func clientGet(shell *Shell, args []string) {
	return sehll.c.SendRequest(raft.GET, []byte(args[1]))
}

//This function removes somehting form the log
func clientRemove(shell *Shell, args []string) {
